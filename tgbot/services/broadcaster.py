...
async def send_message(
    ...
    try:
        ...
        return await send_message(
            bot, user_id, text, disable_notification, reply_markup, protect_content
        )  # Recursive call
...
async def send_message_audio(
    ...
    try:
        ...
        await asyncio.sleep(e.retry_after)
        return await send_message_audio(
            bot, user_id, text, audio, disable_notification, reply_markup
        )  # Recursive call
    except exceptions.TelegramAPIError:
        logging.exception(f"Target [ID:{user_id}]: failed")
    else:
